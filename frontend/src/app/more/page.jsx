  ...
  return (
    <div className="relative min-h-screen bg-black text-white font-body selection:bg-white/20 flex flex-col justify-center overflow-hidden">
      ...
      <main className="relative z-10 max-w-4xl mx-auto px-6 w-full text-center mt-8">
        ...
        Get early access to premium music production services including original compositions, beat production, voiceover, mixing, mastering, and custom sound experiences.Drop your email below and be first to experience the launch.
        </p>
